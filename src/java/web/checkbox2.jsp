...
if(rs3.next())
{
  ...
  rs2=stmt.executeQuery("select  * from seat where booked ='"+seat+"'");
  if(rs2.next())
  {
...
if(rs1.next())
{   
 out.print("<br> <h3 style='background-color: green'> Please Pay to complete your booking </h3>!!!<a href='booking1.jsp'>BOOKING</a>");
